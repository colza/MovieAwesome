...
public class Constants {
    ...
    public static final String ATTACH_API_KEY_AS_FIRST_PARAM = "?api_key=" + API_KEY_VALUE;
    ...
    public static final String RESTFUL_GET_TV_GENRE_LIST = Constants.BASE_URL + Constants.GENRE + Constants.CATE_TV + LIST + ATTACH_API_KEY_AS_FIRST_PARAM;
